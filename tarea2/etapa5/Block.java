...
public class Block extends PhysicsElement implements Computable, Collidable, SpringAttachable, ElasticAttachable {
	...
	private BlockView view;  // Block view of Model-eView-Controller design pattern
