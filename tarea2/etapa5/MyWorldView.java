...
public class MyWorldView extends JPanel {
    ...
    /**
    * Asigna listeners de mouse y de movimiento al mundo.
    *
    * @param w el mundo al cual se le asignarán los listeners.
    */
    ...
    /**
    * Dibuja los ejes y textos que se mostrarán en el proyecto para este mundo en específico.
    *
    * @param g el elemento gráfico al cual se le dibujarán ejes y textos.
    */
