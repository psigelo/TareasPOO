...
public class SpringView {
   ...
   public SpringView(Spring spring) {
      ...
      double  x;
         ...
         AffineTransform at = AffineTransform.getTranslateInstance(0,0);
          if(this.spring.a_end != null && this.spring.b_end !=null){
            x = Math.abs(this.spring.a_end.obtener_extremo_derecho() - this.spring.b_end.obtener_extremo_izquierdo());
         }
         else{
            x = 1.0;
         }
   ...
   public void updateView (Graphics2D g){
      if(this.spring.a_end != null && this.spring.b_end !=null){
         double ax=this.spring.a_end.obtener_extremo_derecho();
         double xa_b = Math.abs(this.spring.a_end.obtener_extremo_derecho() - this.spring.b_end.obtener_extremo_izquierdo());
